  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-[var(--color-muted)]">
        {isTeacher
          ? "أنشئ أكواد تفعيل لدوراتك فقط ووزّعها على العملاء. يمكنك نسخ الأكواد، تمييز آخر دفعة، وحذف الأكواد التي لم تُستخدم."
          : "إنشاء أكواد تفعيل مجانية لدورة معيّنة وتوزيعها على العملاء. يمكنك نسخ كل الأكواد مرة واحدة، التمييز بين القديم والجديد، وحذف الأكواد نهائياً."}
      </p>
