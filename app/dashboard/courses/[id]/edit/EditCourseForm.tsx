  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 max-w-3xl space-y-8">
      <CourseFormSaveOverlay
        ...
        subtitle="يتم تحديث الحصص والاختبارات، قد يستغرق ذلك بعض الوقت."
      />
      {error && (
      ...
      <section className="rounded-[var(--radius-card)] border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-[var(--color-muted)]">أقصى عدد مرات يسمح فيها للعميل بحل اختبارات هذا الكورس (مجموع كل الاختبارات). اتركه فارغاً لعدم التحديد.</p>
          </div>
          <div>
          ...
          <label className="flex items-center gap-2">
            ...
            <span className="text-sm text-[var(--color-foreground)]">الدورة منشورة (ظاهرة للعملاء)</span>
          </label>
        </div>
      </section>
